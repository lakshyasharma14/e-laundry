...
else
{
    ...
    <html>
        ...
        <body style="padding:20px;"> 
            <% rs=s.executeQuery("select s.Roll_no,bill_no,Del_date,Total_due,Mobile_No from services s,user u where u.Roll_no=s.Roll_no and status='R' and Del_mode='Delivery' order by bill_no ");%>
