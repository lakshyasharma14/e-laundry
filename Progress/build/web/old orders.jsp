...
<div class="main_container">
    ...
    <div class="middle">
        <div class="container">
            <div class="row">
                <div class="col-sm-3 col-xs-6 exstylegrid hover-control"><a href="mainpage.html" class="main-link">New Orders</a></div>
                <div class="col-sm-3 col-xs-6 exstylegrid current-selection"><a href="oldorders.html" class="main-link">Old Orders</a></div>
