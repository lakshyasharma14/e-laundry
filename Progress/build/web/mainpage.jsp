				...
				<div class="col-sm-3 col-xs-6 exstylegrid hover-control"><a href="pickdel.jsp" class="main-link">Pickup/Delivery Details</a></div>
                        ...
                        <div class="row exstylegrid2" style="border-radius: 10px;">
                                ...
                                <form method="pull" action="mainpage.jsp">
                                    ...
                                    <select name="dept" style="color:black;" onchange="submit()">
                                        ...
                                        %><option style="color:black;" value="<%out.println(rs.getString(1));%>" <%if(opt==null){out.println("style=\"color:green;\"");}
                                            else if(opt.equals(rs.getString(1))){out.println("selected");}%>><%out.println(rs.getString(2));%></option>
                                           <% }
                                        %>
                                    </select>
                                </form>
                            ...
                            <div class="col-sm-6 leftb wow">
                                ...
                                <table style="margin:20px auto;" class="tab">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="deleteProcOrder.jsp?mode=dry_clean&bill_no=<%out.println(rs.getString(4));%>&job_id=<%out.println(rs.getString(5));%>" class="btn btn-default">R</a></td>
                                        </tr>
                                        <%}%>
                                        ...
                                        <tr>
                                            ...
                                            <td><%out.println(rs.getString(2));%></td>
                                            <td><%out.println(rs.getString(3));%></td>
                                            <td><a href="deleteProcOrder.jsp?mode=washing&bill_no=<%out.println(rs.getString(4));%>&job_id=<%out.println(rs.getString(5));%>" class="btn btn-default">R</a></td>
                                        </tr>
                                        <%}%>
                                        ...
                                        <tr>
                                            ...
                                            <td><%out.println(rs.getString(2));%></td>
                                            <td><%out.println(rs.getString(3));%></td>
                                            <td><a href="deleteProcOrder.jsp?mode=ironing&bill_no=<%out.println(rs.getString(4));%>&job_id=<%out.println(rs.getString(5));%>" class="btn btn-default">R</a></td>
                                        </tr>
                                        <%}%>
                                    </tbody>
                                </table>
